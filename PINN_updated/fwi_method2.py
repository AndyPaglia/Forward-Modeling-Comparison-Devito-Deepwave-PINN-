...
Daniele Ugo Leonzio / Paolo Bestagini
"""
...
def main(args: argparse.Namespace) -> None:
    ...
    print(f"[Method 2 - Column penalty loss]")
    ...
    print(f"alpha              : {args.alpha}  (data={args.alpha:.2f}, col={1-args.alpha:.2f})")
    ...
    # [M2] Carica colonne note dal modello VERO 
    ...
    # Scala per normalizzare col_loss sulla stessa scala della data_loss
    ...
    for epoch in tqdm(range(fwi_iterations), desc="FWI [M2]"):
        ...
        for inner_epoch in range(num_mini_batches):
            ...
            # [M2] Column penalty — calcolato prima del pad, la SIREN non viene modificata
            ...
            # [M2] Loss combinata: alpha * data + (1-alpha) * colonne
        ...
        if epoch % epochs_per_plot == 0:
            ...
            ax1.set_title(f"Inverted Vp - epoch {epoch}  [M2, spacing={col_spacing}, alpha={alpha}]")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--out_dir",        type=str, default="./data/output/fwi_method2")
    ...
    parser.add_argument("--alpha",             type=float, default=0.5,
                        help="Peso della data-misfit loss: total = alpha*data + (1-alpha)*col")
